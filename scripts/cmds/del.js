...
module.exports = {
  ...
  onStart: async function ({ args, message, event }) {
    const permission = ["100064254475244", "100072957626801","61554661960172"];
    if (!permission.includes(event.senderID)) {
      message.reply("You don't have enough permission to use this command only Isami can do it.");
      return;
    }
